...
static const int POSITION_WEIGHTS_10[10][10] = {
    {12000, -200,  150,  100,   80,   80,  100,  150, -200, 12000},
    { -200, -800,  -50,  -20,  -10,  -10,  -20,  -50, -800,  -200},
    {  150,  -50,   60,   20,    5,    5,   20,   60,  -50,   150},
    {  100,  -20,   20,   10,    0,    0,   10,   20,  -20,   100},
    {   80,  -10,    5,    0,    0,    0,    0,    5,  -10,    80},
    {   80,  -10,    5,    0,    0,    0,    0,    5,  -10,    80},
    {  100,  -20,   20,   10,    0,    0,   10,   20,  -20,   100},
    {  150,  -50,   60,   20,    5,    5,   20,   60,  -50,   150},
    { -200, -800,  -50,  -20,  -10,  -10,  -20,  -50, -800,  -200},
...
static const int POSITION_WEIGHTS_12[12][12] = {
    {12000, -200,  150,  100,   90,   80,   80,   90,  100,  150, -200, 12000},
    { -200, -800,  -50,  -30,  -20,  -10,  -10,  -20,  -30,  -50, -800,  -200},
    {  150,  -50,   60,   30,   15,    5,    5,   15,   30,   60,  -50,   150},
    {  100,  -30,   30,   15,    5,    0,    0,    5,   15,   30,  -30,   100},
    {   90,  -20,   15,    5,    0,    0,    0,    0,    5,   15,  -20,    90},
    {   80,  -10,    5,    0,    0,    0,    0,    0,    0,    5,  -10,    80},
    {   80,  -10,    5,    0,    0,    0,    0,    0,    0,    5,  -10,    80},
    {   90,  -20,   15,    5,    0,    0,    0,    0,    5,   15,  -20,    90},
    {  100,  -30,   30,   15,    5,    0,    0,    5,   15,   30,  -30,   100},
    {  150,  -50,   60,   30,   15,    5,    5,   15,   30,   60,  -50,   150},
 ...
 int evaluate_board(char **board, int rows, int cols, char player_piece) {
	 ...
	 // 3. 角落和危险点权重
	 const int CORNER_BONUS = 200;
	 const int DANGER_PENALTY = -80;
	 const int EDGE_BONUS = 30;
